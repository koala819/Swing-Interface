...
public class U3D_Forme3D_MonMouseCUBE3D {
	...
	static BranchGroup createSceneGraph(JCanvas3D jCanvas3D)
	{
	    ...
	    // Donne la permission au TransformGroup d'être modifié
	    rightTranslationTG.setCapability(TransformGroup.ALLOW_TRANSFORM_WRITE);
	    centerTranslationTG.setCapability(TransformGroup.ALLOW_TRANSFORM_WRITE);
